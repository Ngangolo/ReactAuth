...
function DashboardEntrepreneur() {
    return (
        <Layout>
                    ...
                    <div className="container-fluid">
                        <div className="row mb-2">
                            <div className="col-sm-6">
                                <h1 className="m-0">Dashboard Entrepreneur</h1>
                            </div>
                            <div className="col-sm-6">
                            ...
                            <section className="col-lg-7 connectedSortable">
                                ...
                                <div className="card">
                                    ...
                                    <div className="card-footer clearfix">
                                        <button type="button" className="btn btn-primary float-right"><i className="fas fa-plus"></i> Add
                                            item</button>
                                    </div>
                                </div>
                            </section>
